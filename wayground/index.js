// Store the original page title (if it exists)
const originalTitle = document.title || ""; 
// Define your custom out-of-focus text and favicon URL
const awayTitle = "Quizizz is now Wayground | Teacher AI and Resources";
const awayFavicon = "https://wayground.com/favicon.ico";
// Helper function to create elements compatible with both HTML and XHTML
